...
namespace App\Api\Enum\Error;

use App\Api\Enum\Error\TokenValidation\ApiTokenValidationErrorCodeEnum;

class ApiErrorCodeEnum
{
    public const TOKEN_VALIDATION_001 = ApiTokenValidationErrorCodeEnum::TOKEN_VALIDATION_001;
